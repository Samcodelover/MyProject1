...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    @Then("user clicks on EmployeeList option")
    ...
    @Then("user see employee infromation is displayed")
    public void user_see_employee_infromation_is_displayed() {
    ...
    public void user_enters_valid_employee_name() {
        ...
        //sendText(searchNameField, "65424564wfv%$");

        sendText(employeeList.empSearchNameField, "65424564wfv%$");
    }
